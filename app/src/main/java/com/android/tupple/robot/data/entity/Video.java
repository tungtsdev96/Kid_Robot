...
public class Video {
    ...
    public Video(String title, String media_url, String thumbnail, String description) {
        this.title = title;
    ...
    public static List<Video> fakeData() {
        List<Video> videos = new ArrayList<>();
        videos.add(new Video("Sending Data to a New Activity with Intent Extras",
        ...
        videos.add(new Video("REST API, Retrofit2, MVVM Course SUMMARY",
        ...
        videos.add(new Video("MVVM and LiveData",
        ...
        videos.add(new Video("Swiping Views with a ViewPager",
        ...
        videos.add(new Video("Database Cache, MVVM, Retrofit, REST API demo for upcoming course",
